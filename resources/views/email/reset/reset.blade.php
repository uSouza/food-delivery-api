            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td style="border-bottom:2px solid #ccc;padding:30px 0 30px 0;">
                        <span style="color:#888;font-size:22px;">Olá!</span>
                        <p style="color:#888;font-size:16px;">Recebemos sua solicitação de redefinição de senha. </p>
                        <p style="color:#888;font-size:16px;">Favor, clique no link abaixo para redefinir sua senha.</p>
                        <p style="color:#888;font-size:16px;"><a href="{{$url}}">Redefinir senha</a></p>
                    </td>
                </tr>
            </table>
        </td>
